...
export const getBlogById = async (req, res) => {
    try {
        const { blogId } = req.params; // correct param name
        ...
        return res.json({ success: true, blog }); // correct response key
    } catch (error) {
        res.json({ success: false, message: error.message });
    }
};
...
export const generateContent =async (req,res)=>{
    try {
        ...
        const content = await main(prompt + 'Generate a blog for this in simple text format')
